  ...
  return (
    <div className="min-h-screen bg-[#382F2D] text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#651C32]/85 backdrop-blur-sm border-b border-[#CBC4BC]/20">
        <div className="container mx-auto px-8 md:px-12 lg:px-24 h-20 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-2 px-4 py-1.5 bg-amber-500/90 rounded-full border border-amber-400/50 shadow-lg shadow-amber-500/20">
              <span className="text-sm font-medium text-[#382F2D]">
                {notification.text}
              </span>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen pt-12 relative flex items-center">
        ...
        <div className="container relative z-10 mx-auto px-8 md:px-12 lg:px-24 flex items-center justify-between">
          <div className="max-w-2xl space-y-6 flex flex-col items-center text-left -mt-20">
            <div className="w-80 h-80 mb-6 rounded-full overflow-hidden border-4 border-white/20 shadow-xl self-center">
              <img 
            ...
            <div className="w-full">
              ...
              <p className="text-2xl text-[#CBC4BC] font-light leading-relaxed italic">
                {hero.quote}
              </p>
      ...
      {/* About Section */}
      <section id="about" className="min-h-screen py-32 bg-[#CBC4BC]">
        <div className="container mx-auto px-8 md:px-12 lg:px-24">
          <div className="max-w-4xl mx-auto space-y-12">
            <h2 className="text-5xl font-bold tracking-tight text-[#382F2D] text-center">
              {about.title}
            </h2>
      ...
      {/* Platform Section */}
      <section id="platform" className="min-h-screen py-32 bg-[#CBC4BC]/30">
        <div className="container mx-auto px-8 md:px-12 lg:px-24">
          <h2 className="text-5xl font-bold text-center mb-20 tracking-tight text-[#CBC4BC]">
            {platform.title}
          </h2>
      ...
      {/* Updates Section */}
      <section id="updates" className="min-h-screen py-32 bg-[#CBC4BC]">
        <div className="container mx-auto px-8 md:px-12 lg:px-24">
          <h2 className="text-5xl font-bold text-center mb-20 tracking-tight text-[#382F2D]">
            {updates.title}
          </h2>
      ...
      {/* Contact Section */}
      <section id="contact" className="min-h-screen py-32 bg-[#CBC4BC]/30">
        <div className="container mx-auto px-8 md:px-12 lg:px-24">
          <div className="max-w-xl mx-auto text-center space-y-8">
            <h2 className="text-5xl font-bold tracking-tight text-[#CBC4BC]">
              {contact.title}
            </h2>
